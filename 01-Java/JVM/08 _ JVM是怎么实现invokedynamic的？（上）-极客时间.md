...
Method 
 ...
 = Foo.class.getDeclaredMethod("bar", Object.class);
...
public 
 ...
 @PolymorphicSignature Object invokeExact(Object... args) 
...
public 
 ...
 test(MethodHandle mh, String s) throws Throwable {
...
public 
 ...
 test(MethodHandle, String) throws java.lang.Throwable;
...
at java.base/java.lang.invoke.LambdaForm$MH000/766572210\. invokeExact\_MT000\_LLL_V(LambdaForm$MH000:1000019)
...
final 
 ...
 java.lang.invoke.LambdaForm$MH000 { static 

 void 

 invokeExact\_MT000\_LLLLV(jeava.lang.bject, jjava.lang.bject, jjava.lang.bject);
...
: aload_32 : checkcast #16

10: invokestatic I#22

13: aload_0

14: invokestatic #26 I

17: aload_0

18: aload_1

19: ainvakevirtudl #30 
...
Java 虚拟机同样会对 invokeBasic 调用做特殊处理，这会将它调用到方法句柄本身所持有的适配器中。这个适配器同样是一个 LambdaForm，你可以通过反射机制将其打印出来。

DMH.invokeStatic\_L\_V=Lambda(a0:L,a1:L)=>{
...
final 
 ...
 java.lang.invoke.LambdaForm$DMH000 

 {

static 

 void invokeStatic000\_LL\_V(java.lang.Object, java.lang.Object);
