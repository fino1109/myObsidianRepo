...
void 
 ...
 invoke(String s, Object obj, Object... args) { ... }
...
在 Java 中，方法存在重载以及重写的概念，重载指的是方法名相同而参数类型不相同的方法之间的关系，重写指的是方法名相同并且参数类型也相��的方法之间的关系。
...
public 
 ...
 actionPrice(double price, T customer) {
...
public 
 ...
 actionPrice(double price, VIP customer) {
...
![[56758ca937966ea60942b022e7561772_2c6e3fc7dc444fd8b.png]]
