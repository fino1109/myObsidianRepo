...
![[f6982eb85dc66bd04200474efb3a050e_ca841096b670406cb.png]]

说到网络协议，我们还需要简要介绍一下两种网络协议模型，一种是 OSI 的标准七层模型，一种是业界标准的 TCP/IP 模型。它们的对应关系如下图所示：

![[92f8e85f7b9a9f764c71081b56286e0e_52fcfa274065441c9.png]]
...
从第三层，我们往下看，第二层是数据链路层。有时候我们简称为二层或者 MAC 层。所谓 MAC，就是每个网卡都有的唯一的硬件地址（不绝对唯一，相对大概率唯一即可，类比UUID）。这虽然也是一个地址，但是这个地址是没有全局定位功能的。
...
![[98a4496fff94eb02d1b1b8ae88f8dc28_64d9fbc86f4d4e758.jpg]]
...
![[8c0a95fa07a8b9a1abfd394479bdd637_a7a40ceef7804538a.jpg]]

![[224be263c627a6598436b1cd91e87750_ab75dc3d04dc428c9.png]]
