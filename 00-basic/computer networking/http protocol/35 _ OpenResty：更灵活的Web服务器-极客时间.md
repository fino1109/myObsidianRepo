...
![[9f7b79c43c476890f03c2c716a20f301_0b550f39b2e944738.png]]
...
![[4f24aa3f53969b71baaf7d9c7cf68fd5_0c826b4aba954479a.png]]
...
![[9fc3df52df7d6c11aa02b8013f8e9bc6_be72090dbc5b4e7db.png]]

下面的代码是一个简单的例子，读取 POST 发送的 body 数据，然后再发回客户端：

ngx.req.read_body()

local data = ngx.req.get\_body\_data()
...
![[3689312a970bae0e949b017ad45438df_2074d116cd4d4411b.png]]
...
而在 OpenResty 里就可以使用指令“ssl\_certificate\_by_lua”，编写 Lua 脚本，读取 SNI 名字后，直接从共享内存或者 Redis 里获取证书。不仅没有读盘阻塞，而且证书也是完全动态可配置的，无需修改配置文件就能够轻松支持大量的 HTTPS 虚拟主机。
...
![[c5b7ac40c585c800af0fe3ab98f3449f_236ca2b114f9462ca.png]]

![[56758ca937966ea60942b022e7561772_29d3c3da81664220b.png]]
